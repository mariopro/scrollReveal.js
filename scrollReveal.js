...
var _requestAnimFrame
  ...
  scrollReveal.prototype = {
    ...
    /**
     * performs a fresh query of the DOM for data-scroll-reveal attributes,
     * and binds event listeners to the returned elements.
     *
     * TODO: De-couple the first animate() call, from the init() method.
     */
    init: function() {
      ...
      self.elems.forEach(function ( el ) {
         ...
         *
         * [data-scroll-reveal] { visibility: hidden }
         *
         * set in the page styles...
         *
         * This then override CSS visibility to avoid content being incorrectly
         * shown momentarily before scrollReveal JavaScript initialized.
         */
        tempStyle = el.getAttribute( 'style' )
    ...
    parse: function( el ) {
       ...
       */
      if ( typeof parsed.reset === 'undefined' ) {

        parsed.reset = self.config.reset
      }
